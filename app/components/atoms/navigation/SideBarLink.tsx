...
function SideBarLink(Props: SideBarLinkProps) {
    ...
    return (
        <Link href={Props.To} className={clsx("font-bold text-base p-2 rounded-lg flex items-center hover:bg-brand-purple-extra-light hover:text-brand-purple-light transition-all duration-300",
